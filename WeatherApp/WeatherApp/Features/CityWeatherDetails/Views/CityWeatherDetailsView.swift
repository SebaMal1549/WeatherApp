...
final class CityWeatherDetailsView: UIView {
    ...
    func configureView(with weatherData: WeatherData, and city: City) {
        DispatchQueue.main.async { [weak self] in
            ...
            realFeelTemperatureTile.reloadView(title: "Temperatura odczuwalna", value: weatherData.formattedRealFeelTemperature)
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            gridView.topAnchor.constraint(equalTo: mainStackView.bottomAnchor, constant: temperatureLabelVerticalMargin),
